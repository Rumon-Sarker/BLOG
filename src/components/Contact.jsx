...
const Contact = () => {
    return (
        <div>
            <section className="bg-gray-300 my-10">
                <div className="py-8 lg:py-16 px-4 mx-auto  max-w-screen-md">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 ">Contact <span className='text-orange-500'>Us</span></h2>
                    ...
                    <form action="#" className="space-y-8">
                        <div>
                            ...
                            <input type="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5 " placeholder="name@flowbite.com" required />
                        </div>
                        <div>
                        ...
                        <button type="submit" className="py-3 px-5 text-sm font-medium bg-gray-400 text-center rounded-lg sm:w-fit">Send message</button>
                    </form>
                </div>
            </section>
        </div>
